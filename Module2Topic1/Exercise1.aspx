...
<body>
    ...
    <form runat="server">
        <%-- DONE 2.1 Create a label displaying the name of your favorite song and its artist (e.g. Yesterday - The Beatles)--%>
        <%-- Hint: https://www.tutorialspoint.com/asp.net/asp.net_custom_controls.htm#:~:text=Label --%>
        <asp:Label ID="Song" runat="server" Text="Until I Found You"></asp:Label>

        <%-- DONE 2.2 Create an image that is 200px by 200x big showing the album cover of your favorite song. Make sure to set the alternative text. --%>
        <%-- Hint: https://www.tutorialspoint.com/asp.net/asp.net_basic_controls.htm#:~:text=Image%20Control --%>
        <asp:Image ID="AlbumCover" runat="server" imageURL="https://i.pinimg.com/originals/50/6c/1f/506c1ffc76f09555f59b8a13d4568f05.jpg" Width="200px" Height="200px"></asp:Image>

        <%-- DONE 2.3 Create three buttons with texts. "Prev", "Play", and "Next" --%>
        ...
        <%-- DONE 2.4 Create a span. Once the play button is pressed, the span should display "Now playing <favorite song>" --%>
        ...
        <%-- DONE 2.5 Display the current time using the template syntax <%= %> --%>
